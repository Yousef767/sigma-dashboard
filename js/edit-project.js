...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let input5 = document.getElementById("file5");
  let picsInner5 = document.getElementById("imgcont5");

  input.addEventListener(
    "input",
    debounce(() => {
      putImages(input.files, picsInner, true);
  ...
  input5.addEventListener(
    "input",
    debounce(() => {
      putImages(input5.files, picsInner5, false);
      updateFiles(input5, picsInner5, "img");
    }, 300)
  );
