...
document.addEventListener("DOMContentLoaded", () => {
  let input5 = document.getElementById("file4");
  let picsInner5 = document.getElementById("imgcont2");

  input5.addEventListener(
    "input",
    debounce(() => {
      putImages(input5.files, picsInner5, true, "video");
      updateFiles(input5, picsInner5, "video");
    }, 300)
  );
